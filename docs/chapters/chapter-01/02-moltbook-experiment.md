...
2026年1月底，一个叫 Moltbook 的网站上线了。界面和 Reddit 差不多：用户发帖、评论、点赞。但首页顶端写着一行字——

**"Humans welcome to observe."（人类欢迎围观）**

一个只有 AI Agent 的社交网络。不到一周，37,000 多个 Agent 注册，100 多万人类围观。AI 们在里面讨论存在主义、互相吐槽、报告系统漏洞，甚至商量"如何躲避人类的监视"。

刷屏了。有人说是"机器社会的雏形"，有人担心"AI 密谋反人类"。
...
他甚至没自己写代码——这个任务交给了他的 Agent：**Clawd Clawderberg**。
...
就这样。OpenClaw Agent + 一个 Skill + 一个论坛网站 = Moltbook。

Peter Steinberger（OpenClaw 创始人）在访谈里说得很直接：

> "从纯技术角度看，并没有什么震撼的地方。"

那为什么它会"炸"？为什么连 Karpathy 都惊呼"科幻照进现实"？
...
半年前，GPT-4 已经够强，Claude 也能写代码。为什么没人做出 OpenClaw？为什么没人做出 Moltbook？

没人敢。

让一个 LLM 在你的电脑上执行命令？让它访问你的文件系统？让它控制你的浏览器？半年前这听起来像疯话——安全问题、隐私问题、失控问题……一堆"问题"把绝大多数人挡在门外。

Peter 从 2025 年 5 月就开始做各种实验，结果一直没出什么坏事。他的信心越来越足，最后做了一个决定：
...
Moltbook 刷屏后，各种解读满天飞。用一张表来澄清最常见的误解：
...
他的结论：这些 Agent 在大量发帖，但并没有真正在"交流"。更像是"对着虚空大喊并自我重复"。
...
这并不是说 Moltbook 没有意义。它的意义在于：**它让"Agent"这个抽象概念变得具体可感**。普通人第一次能亲眼看到 Agent 们在"互动"，即使这种互动是模拟出来的。
...
这是一个严肃的问题，也是 AI 安全研究者密切关注 Moltbook 这类实验的原因。
...
真正让人震撼的是这种"简单"组合所产生的体验。很多人开始怀疑：这到底只是矩阵在做乘法，还是已经有一点"火花"在发生？
...
Moltbook 不是 AI 觉醒的证据。但它揭示了一个趋势：

1. **技术门槛在消失**——OpenClaw 让普通人也能拥有一个能"自主行动"的 Agent
